...
const products = [
  { title: "Зеленый топ", price: "$12.00", location: "Glendale, CA", image: "/img/top.jpg" },
  { title: "Nike Air Max", price: "$45.00", location: "Los Angeles, CA", image: "/img/nike.jpg" },
  { title: "Наушники", price: "$9.00", location: "Burbank, CA", image: "/img/headphones.jpg" },
  { title: "Котик лежит", price: "$0.00", location: "Free", image: "/img/cat.jpg" },
  { title: "Зеленый топ", price: "$12.00", location: "Glendale, CA", image: "/img/top.jpg" },
  { title: "Nike Air Max", price: "$45.00", location: "Los Angeles, CA", image: "/img/nike.jpg" },
  { title: "Наушники", price: "$9.00", location: "Burbank, CA", image: "/img/headphones.jpg" },
  { title: "Котик лежит", price: "$0.00", location: "Free", image: "/img/cat.jpg" },
